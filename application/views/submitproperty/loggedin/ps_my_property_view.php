<?php
	/*
		Document	:	ps_my_property_view.php
		Created		:	12/12/2013	9.48 PM
		Author 		:	chegzcol
		...
		<div class="contaier">
			<div class="row">
                ...
                <div class="span4 small-list">
                	...
                	<a title="view property" href="<?php echo site_url(); ?>/property_details/viewproperty/?propertyid=<?php echo $row->user_id; ?>"><img src="img/img/small-pic-1.jpg" /></a>
